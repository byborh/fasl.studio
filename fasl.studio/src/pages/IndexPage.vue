<template>
  <div id="app">
    ...
    <div style="margin-top: 50px; background: rgb(91, 91, 138); width: 100%; height: auto">
      <q-card v-for="i in produit" :key="i" class="my-card bg-secondary text-white">
        <q-card-section>
...
export default defineComponent({
  name: 'IndexPage',
  setup () {
    // const email = ref("test@gmail.fr");
    // const userName = ref("test name");
    // const count = ref(1);
    // const minCount = 1;
    // const maxCount = 10;
    // const firstName = ref("Cristiano");
    // const lastName = ref("Ronaldo");
    // const pseudo = ref("cr7")
    // const produit = [1, 2]
    ...
    return {
      // email, userName, count, minCount, maxCount, firstName, lastName, pseudo, produit,
